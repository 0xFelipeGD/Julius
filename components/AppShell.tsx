...
const tabs = [
  {
    ...
    label: 'Chat',
    icon: (active: boolean) => (
      <svg xmlns="http://www.w3.org/2000/svg" fill={active ? '#2563EB' : 'none'} viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={`h-5 w-5 transition-colors ${active ? 'text-julius-accent' : 'text-julius-muted'}`}>
